        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <FIcons
                name="person"
                style={{
                  color: isUser ? css.brandPrimary : '#aaaaaa',
                  elevation: 8,
                }}
          ...
          <View style={{marginTop: 10}}>
            <View
              ...
              <IOcons name="mail-outline" color="#aaaaaa" size={25} />
              <TextInput
                placeholder="Email"
                value=""
            ...
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('Reset Mail')}>
              <TextComp
                style={{color: 'blue', fontSize: widthPercentageToDP(4)}}>
